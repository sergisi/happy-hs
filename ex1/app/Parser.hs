...
action_0,
 ...
 action_48,
 action_49,
 action_50 :: () => Prelude.Int -> ({-HappyReduction (Alex) = -}
	   Prelude.Int 
	-> (LexerT)
...
happyReduce_1,
 ...
 happyReduce_25,
 happyReduce_26,
 happyReduce_27 :: () => ({-HappyReduction (Alex) = -}
	   Prelude.Int 
	-> (LexerT)
	-> HappyState (LexerT) (HappyStk HappyAbsSyn -> (Alex) HappyAbsSyn)
	-> [HappyState (LexerT) (HappyStk HappyAbsSyn -> (Alex) HappyAbsSyn)] 
...
happyExpList = Happy_Data_Array.listArray (0,127) ([46848,1569,7024,98,64,0,0,960,476,7024,98,8631,28678,25115,0,0,0,0,512,0,32,46848,1569,7024,98,8631,6,4,46848,1569,0,0,0,0,0,0,0,0,0,8631,28678,25115,3008,476,49164,49157,23552,28672,25115,46848,1569,7024,98,8631,28678,25115,46848,1569,7024,98,8631,28678,25115,46848,1569,49164,49157,23552,0,0,0,0,0,0,0,3072,1472,192,92,0,0,0,0,0,960,476,49212,29,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_calc","Line","Assign","Exp","'*'","'/'","'+'","'-'","'('","')'","int","double","';'","rvar","ivar","'='","'%'","\">>\"","\"<<\"","'~'","'&'","'|'","'^'","\"cast\"","\"real\"","%eof"]
...
action_5 (27) = happyShift action_14
...
action_16 (5) = happyGoto action_50
...
action_29 (6) = happyGoto action_44
...
action_37 (7) = happyShift action_27
action_37 (8) = happyShift action_28
...
action_38 (23) = happyShift action_34
...
action_43 (20) = happyShift action_32
action_43 (21) = happyShift action_33
action_43 (23) = happyShift action_34
...
action_44 (20) = happyShift action_32
action_44 (21) = happyShift action_33
action_44 (23) = happyShift action_34
...
happyReduction_23 (HappyTerminal (LInt happy_var_1))
	 =  HappyAbsSyn5
		 (TVal happy_var_1
	)
...
happyReduction_24 (HappyTerminal (LDouble happy_var_1))
	 =  HappyAbsSyn5
...
happyReduction_26 (HappyTerminal (LRealReg happy_var_1))
	 =  HappyAbsSyn5
...
happyReduction_27 (HappyTerminal (LIntReg happy_var_1))
	 =  HappyAbsSyn5
		 (TIntGet happy_var_1
	)
...
happyNewToken action sts stk
	...
	case tk of {
	LEOF -> action 28 28 tk (HappyState action) sts stk;
	LMult -> cont 7;
	LDiv -> cont 8;
	LSum -> cont 9;
	LMinus -> cont 10;
